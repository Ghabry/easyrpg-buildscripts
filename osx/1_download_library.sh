...
function download_and_extract {
	...
	wget --no-check-certificate -nv -N $url
	tar xf $file
}
...
# libpng
rm -rf libpng-1.6.26/
download_and_extract http://prdownloads.sourceforge.net/libpng/libpng-1.6.26.tar.xz

# freetype
rm -rf freetype-2.7/
download_and_extract http://download.savannah.gnu.org/releases/freetype/freetype-2.7.tar.bz2

# harfbuzz
rm -rf harfbuzz-1.3.3/
download_and_extract http://www.freedesktop.org/software/harfbuzz/release/harfbuzz-1.3.3.tar.bz2
...
# mpg123
rm -rf mpg123-1.23.8/
download_and_extract http://www.mpg123.de/download/mpg123-1.23.8.tar.bz2
...
# wildmidi
rm -rf wildmidi-0.3.10/
download_and_extract https://github.com/Mindwerks/wildmidi/archive/wildmidi-0.3.10.tar.gz
...
# icudata
rm -f icudt*.dat
download_and_extract https://ci.easyrpg.org/view/All/job/icudata/lastSuccessfulBuild/artifact/icudata.tar.gz
